...
class SparsityCallback(Callback):
    ...
    def on_epoch_end(
        ...
        if pruned_layers > 0:
            ...
            print(
                f"   ✂️ Sparsity applied: target={self.target_sparsity:.2%},  "
