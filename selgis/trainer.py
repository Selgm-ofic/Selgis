...
from selgis.callbacks import Callback, LoggingCallback, SparsityCallback
    ...
    def load_model(self, path: str, weights_only: bool = True) -> None:
        ...
        if weights_only:
            try:
                ...
                print("⚠️ WARNING: weights_only=True not supported (PyTorch < 2.0). Loading with weights_only=False — only use with trusted checkpoints!")
...
class TransformerTrainer(Trainer):
    ...
    def _load_model(self, path: str, config: TransformerConfig) -> nn.Module:
        ...
        trust = True
        load_kw = {"trust_remote_code": trust}
    ...
    def _apply_peft(
        ...
        try:
            ...
            print(f"   🔧 LoRA applied: {trainable_params:,} / {total_params:,} params trainable  "
    ...
    def _create_optimizer(
        ...
        if config.optimizer_type == "adafactor":
            try:
                ...
                print("⚠️ Adafactor not available, falling back to AdamW")
